...
const Pending_Order_List = () => {
 ...
 const [getOrderNum, setOrderdatainto] = useState();
  ...
  useEffect(() => {
    fetch(`${apiLinks}/PendingOrderList.php`)
...
return (
  <>
    <div style={{
      ...
      <PathHead pageName="Dashboard > Pending Order List" screen='Get_Item' pageLink="/MainPage"/>
<br />
    ...
    />
          ...
          <MDBTable scrollY maxHeight="68vh" striped bordered small responsive>
  <MDBTableHead>
...
export default Pending_Order_List;
