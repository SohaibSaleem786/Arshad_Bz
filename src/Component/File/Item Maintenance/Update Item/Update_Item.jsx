...
function Update_Item() {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post(`${apiLinks}/update_item.php?TItmId=${TItmId}`, requestBody)
      .then((response) => {
  ...
  useEffect(() => {
    if (selectedImage1) {
      document.getElementById("pic-preview").src =
                        ...
                        <td>
                          ...
                          >
                            <Form.Control
                              ...
                              value={user.uom}
                              onChange={handleInputChange}
                              onKeyDown={(e) => handleEnterKeyPress(ENTER7, e)}
                              ref={ENTER6}
                              className="form-control"
                              style={{
                                height: "27px",
                        ...
                        <td>
                          ...
                          >
                            <Form.Control
                              ...
                              onChange={handleInputChange}
                              onKeyDown={(e) => handleEnterKeyPress(ENTER8, e)}
                              ref={ENTER7}
                            />
                          </Form.Group>
                        </td>
                        ...
                        <td>
                          ...
                          >
                            <Form.Control
                              ...
                              onChange={handleInputChange}
                              onKeyDown={(e) => handleEnterKeyPress(ENTER9, e)}
                              ref={ENTER8}
                            />
                          </Form.Group>
                        </td>
                        ...
                        <td>
                          ...
                          >
                            <Form.Control
                              ...
                              onKeyDown={(e) => handleEnterKeyPress(ENTER11, e)}
                              ref={ENTER10}
                              id="categoryIdd"
                              className="form-control"
                            >
